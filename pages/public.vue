<template>
  <div class="space-y-8">
    <div class="text-center space-y-2">
      ...
      <p class="text-gray-300">Esta página puede ser accedida por cualquier persona</p>
    </div>

    <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 max-w-2xl mx-auto">
      <div class="space-y-6">
        <div class="text-center">
          <h2 class="text-2xl font-semibold mb-4">Estado de la Sesión</h2>
          <div v-if="authUser" class="space-y-4">
            <div class="flex items-center justify-center gap-2">
              <div class="w-3 h-3 bg-green-400 rounded-full animate-pulse"></div>
              <span class="text-lg font-medium">Sesión Activa</span>
            </div>
            <div class="bg-white/5 rounded-lg p-4">
              <p class="text-sm text-gray-400 mb-1">Usuario actual:</p>
          ...
          <div v-else class="space-y-4">
            <div class="flex items-center justify-center gap-2">
              ...
              <span class="text-lg font-medium text-gray-400">No hay sesión activa</span>
            </div>
            <p class="text-gray-400">No estás autenticado actualmente</p>
            <NuxtLink 
              to="/login"
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-sm text-gray-300">
                  Esta es una página pública que puede ser accedida por cualquier persona, 
                  independientemente de si están autenticados o no. Puedes navegar libremente 
                  por esta página sin necesidad de iniciar sesión.
                </p>
              </div>
            </div>
          </div>
